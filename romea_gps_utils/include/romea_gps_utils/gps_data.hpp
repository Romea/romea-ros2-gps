...
protected:
  ...
  void process_gga_frame_(const rclcpp::Time & stamp, const std::string & nmea_sentence);

  void process_rmc_frame_(const rclcpp::Time & stamp, const std::string & nmea_sentence);

  void process_gsv_frame_(const rclcpp::Time & stamp, const std::string & nmea_sentence);
