...
def test_create_nmea_navsat_driver_profile():
    ...
    assert nodes_configuration["nmea_driver"]["namespace"] == "/robot/gps"
...
def test_create_romea_gps_serial_driver_profile():
    ...
    assert nodes_configuration["driver"]["namespace"] == "/robot/gps"
...
def test_create_ntrip_client_profile():
    ...
    assert nodes_configuration["ntrip"]["namespace"] == "/robot/gps"
